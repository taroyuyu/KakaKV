...
namespace kakakv {
    namespace server {
        ...
        protected:
            ...
            doProcessRequestVote(const std::shared_ptr<message::RequestVote> request);
            ...
            doProcessAppendEntries(const std::shared_ptr<message::AppendEntries> appendEntriesMessage);

            void doProcessAppendEntriesResult(const std::shared_ptr<message::AppendEntriesResponse> response);

            void becomeFollower(unsigned long long term, cluster::NodeId votedFor, cluster::NodeId leaderId,
